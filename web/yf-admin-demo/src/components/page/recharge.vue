                    ...
                    <el-table :data="list" stripe border :cell-style="{padding:'3px 0'}">
                        ...
                        <el-table-column label="状态" width="100">
                            <template slot-scope="scope">
                                <el-tag v-if="scope.row.status === 1" type="danger">等待入账</el-tag>
                                <el-tag v-if="scope.row.status === 2" type="success">已到账</el-tag>
                ...
                <div class="pagePopSub">
                    ...
                    <div class="flexWrap w-per100">
                        <div class="group" style="width: 400px">
                            ...
                            <el-input v-model="detail.fund" type="number" class="bottom"  style="width: 280px" placeholder=""></el-input>
                        </div>
                    </div>
                    <div class="flexWrap w-per100">
    ...
    export default {
        data: function(){
            return {
                accountInfo:{},
                filter:{
                    status:"", statusAry:[{v:1, n:'等待入账'},{v:2, n:'已到账'},{v:3, n:'已取消'}],
                    company:"", account:"",
                },
