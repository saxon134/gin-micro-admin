    ...
    <div class="page">
        ...
        <div class="pageCenter">
            <el-table :data="tblData" highlight-current-row stripe border :cell-style="{padding:'2px 0'}">
                ...
                <el-table-column prop="positionStr" label="位置" width="100"></el-table-column>
        ...
        <template v-if="isDetailShow">
            <div class="pagePop" style="height: 100vh">
                        ...
                        <div class="flexWrap" style="width: 500px;">
                            ...
                            <div class="flexWrap">
                                <div class="flexWrap" style="width:160px;">
                                    ...
                                    <el-select v-model="detail.position" clearable placeholder="请选择" style="width:120px;">
                                        <el-option
                            ...
                            <div class="separateView" style="font-size: 13px; margin-top: 25px">图片 <span style="font-size: 11px;font-weight: normal">建议尺寸400×400</span></div>
                            <div class="flexWrap">
            ...
            <div class="pagePop" style="margin: 10px 0 0 550px;width:450px;">
        ...
        data() {
            return {
                filter:{
                    ...
                    position:"", positionAry:[{v:0, n:'仅平台查看'},{v:8, n:'小程序展示'}],
                },
                listAry: [],
                tbl:{size:10, total:0, curr:1},

                detail:{position:"", status:2},
                isDetailShow:false,
                richTxt:"",
        ...
        methods: {
            ...
            toCreate() {
                if (this.detail && this.detail.id) {
                    localStorage.setItem("coServe_content_tmp", "");
                    this.detail = {position:0, status:2};
                    this.richTxt = "";
                }

                let v = localStorage.getItem("coServe_content_tmp");
            ...
            toSubmit() {
                ...
                if (this.detail.title && this.detail.title.length > 64) {
                    this.$message.error("标题过长");
                    return;
                }
                if (this.detail.desc && this.detail.desc.length > 512) {
                ...
                let url = "coserve/content.add";
                if (this.detail.id) {
                    url = "coserve/content.update";
                }
            ...
            toSave:function() {
                localStorage.setItem("coServe_content_tmp", JSON.stringify({
            ...
            fetchList() {
                let url = "coserve/content.list";
                let params = {
                    pageSize:this.tbl.size, pageNumber:this.tbl.curr,
                    position:this.filter.position, status:this.filter.status,
                };
...
<style scoped>
    .list_cover {width:50px;height:50px;object-fit:contain}
